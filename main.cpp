...
int main() {
    switch (42) {
        ...
        case 8:
            cornell_smoke(); break;
        case 9:
            final_scene(800, 10000, 40); break;
...
void checkered_spheres() {
    ...
    auto checker = make_shared<checker_texture>(0.32, color(0.l, 0.l, 0.l), color(.9, .9, .9));
...
void render(camera& cam, hittable_list& world) {
    ...
    std::clog << "Render took: " << elapsed.count() << " seconds\n";
